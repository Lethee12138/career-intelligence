...
Respect task/batch-specific eligibility of evidence. Freeze the evidence cutoff and exclusions in the analysis. The 2026-09-11 Kuaishou/Baidu batch excludes active PAW and Portfolio Studio development; it still permits the completed AR research/low-/mid-fi evidence explicitly listed in that batch. Later AR production completion does not retroactively add high-fi production ownership. AR is read-only.
