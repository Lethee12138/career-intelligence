...
TUNNEL_BIN="${CAREER_TUNNEL_CLIENT_BIN:-$HOME/Library/Application Support/Personal AI Workspace/OpenAI Tunnel/v0.0.11/tunnel-client}"
...
preflight() {
  ...
  printf 'PAW tunnel/config mutation: none\n'
}
