...
Envelope: schema_version, HUMAN_REVIEW_REQUIRED, as_of, mode (ANALYSIS_ONLY / MARKET_VALIDATED), source_coverage, profile_ref, industry_scope, exclusions with sourced reasons, questioning_stop_reason.
